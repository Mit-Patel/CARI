...
import com.avpti.cari.LoginActivity;
...
//        sharedPreferences = this.context.getSharedPreferences(PREF_NAME, PRIVATE_MODE);
    ...
    public void logoutUser() {
        ...
        //Put extra to identify that logout has been done
        i.putExtra("user_logout", 1);

        // Staring Login Activity
        context.startActivity(i);
    }

    public void setName(String re, String re1) {
        //name
        editor.putString(KEY_NAME, re+" "+re1);
        //commit
        editor.commit();
    }
    public void setUsername(String re1) {
        //username
        editor.putString(KEY_USERNAME, re1);
        //commit
        editor.commit();
    }
